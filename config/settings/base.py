...
Common settings shared by dev and prod. Environment-specific values
(DEBUG, ALLOWED_HOSTS, etc.) live in config.settings.dev / config.settings.prod.
"""
...
# Build paths: base.py lives in config/settings/, so project root is parent.parent.parent
